...
exports.subdivisions = void 0;
// https://unece.org/trade/cefact/UNLOCODE-Download UN/LOCODE by Country version 2022-2
// MDB file; SubdivisionCodes Table
exports.subdivisions = [
    ...
    ["BW", "SP", "Selibe Phikwe"],
    ["BW", "ST", "Sowa Town"],
    ["BY", "BR", "Bresckaja voblasć (be) - Brestskaja oblast' (ru)"],
    ["BY", "HM", "Horad Minsk"],
    ["BY", "HO", "Homyel'skaya voblasts' (be) - Gomel'skaya oblast' (ru)"],
    ["BY", "HR", "Hrodzyenskaya voblasts' (be) - Grodnenskaya oblast' (ru)"],
    ...
    ["IR", "01", "Gīlān"],
    ["IR", "02", "Māzandarān"],
    ["IR", "03", "ĀZarbāyjān-e Sharqī"],
    ["IR", "04", "ĀZarbāyjān-e Gharbī"],
    ["IR", "05", "Kermānshāh"],
    ["IR", "06", "Khūzestān"],
    ["IR", "07", "Fārs"],
    ["IR", "08", "Kermān"],
    ...
    ["KG", "T", "Talas"],
    ["KG", "Y", "Ysyk-Köl"],
    ["KH", "1", "Banteay Mean Choăy [Bântéay Méan Choăy]"],
    ...
    ["KZ", "75", "Almaty"],
    ["KZ", "79", "Šimkent"],
    ["LA", "AT", "Attapu [Attapeu]"],
    ["LA", "BK", "Bokèo"],
    ["LA", "BL", "Bolikhamxai [Borikhamxay]"],
    ["LA", "CH", "Champasak [Champasack]"],
    ["LA", "HO", "Houaphan [Huaphanh]"],
    ["LA", "KH", "Khammouan [Khammuane]"],
    ["LA", "LM", "Louang Namtha [Luangnamtha]"],
    ["LA", "LP", "Louangphabang [Luangprabang]"],
    ["LA", "OU", "Oudômxai [Oudomxay]"],
    ["LA", "PH", "Phôngsali [Phongsaly]"],
    ["LA", "SL", "Salavan [Saravane]"],
    ["LA", "SV", "Savannakhét [Savannakhet]"],
    ["LA", "VI", "Vientiane"],
    ["LA", "VT", "Vientiane"],
    ["LA", "XA", "Xaignabouli [Xayabury]"],
    ["LA", "XE", "Xékong [Sekong]"],
    ["LA", "XI", "Xiangkhouang [Xiengkhuang]"],
    ["LA", "XS", "Xaisômboun [Xaysomboon]"],
    ["LB", "AK", "Aakkâr"],
    ["LB", "AS", "Liban‐Nord"],
    ["LB", "BA", "Beyrouth"],
    ...
    ["LV", "047", "Kraslavas novads (Krāslava)"],
    ...
    ["LV", "111", "Augšdaugavas novads (Augšdaugava)"],
    ["LV", "112", "Dienvidkurzemes novads (Dienvidkurzeme)"],
    ["LV", "113", "Valmieras novads (Valmiera)"],
    ["LV", "DGV", "Daugavpils"],
    ["LV", "JEL", "Jelgava"],
    ["LV", "JUR", "Jūrmala"],
    ["LV", "LPX", "Liepāja"],
...
//# sourceMappingURL=provinces_un_locode.js.map