...
const PollForm = (props: FormProps) => {
  ...
  const [allowArbitraryVote, setAllowArbitraryVote] = React.useState(
  ...
  const [requiredPropertyObserver, setRequiredPropertyObserver] =
    React.useState("");
  ...
  const prepareStatement: prepareStatement = ({ method }) => {
    ...
    try {
      let domainScope = domainScopeConcat
        ? domainScopeConcat.split(",").map((s) => s.trim())
        : undefined;
      const content = buildPollContent({
        ...
        domainScope,
        judges: nodes,
        deadline: votingDeadline ? votingDeadline.toDate() : undefined,
        poll,
        options,
        scopeDescription,
        scopeQueryLink,
      ...
      {showOptionalFields ? (
        <>
          <LocalizationProvider dateAdapter={AdapterMoment}>
            <DateTimePicker
              ...
              renderInput={(params) => (
                <TextField {...params} style={{ marginTop: "24px" }} />
              )}
            />
          ...
          <TextField
            ...
            onChange={(e) => {
              setScopeQueryLink(e.target.value);
            }}
            margin="normal"
            sx={{ marginBottom: "12px", marginTop: "24px" }}
          />
          ...
          <TextField
            ...
            onChange={(e) => {
              setRequiredProperty(e.target.value);
            }}
            margin="normal"
            sx={{ marginBottom: "12px", marginTop: "24px" }}
          />
        ...
        /> */}
          <TextField
            ...
            onChange={(e) => {
              setRequiredPropertyObserver(e.target.value);
            }}
            margin="normal"
            sx={{ marginBottom: "12px", marginTop: "24px" }}
          />
          <TextField
            ...
            onChange={(e) => {
              setDomainScopeConcat(e.target.value);
            }}
            margin="normal"
            sx={{ marginBottom: "12px", marginTop: "24px" }}
          />
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField {...params} label="Voting country (optional)" />
            )}
            sx={{ marginTop: "12px" }}
          />
          <Autocomplete
            ...
            options={
              countryObject
                ? cities.filter((l) => l[2] === countryObject[4])
                : []
            }
            autoHighlight
            ...
            renderInput={(params) => (
              <TextField {...params} label="Voting city (optional)" />
            )}
            // @ts-ignore
            renderOption={(props, option) => (
          ...
          <Autocomplete
            ...
            onInputChange={(event, newInputValue) =>
              setLegalForm(newInputValue)
            }
            renderInput={(params) => (
              <TextField {...params} label="Voting legal entities (optional)" />
            )}
            // @ts-ignore
            renderOption={(props, option) => (
              <Box {...props} id={option}>
        ...
        <Button
          onClick={() => {
            ...
            setVotingDeadline(moment().add(14, "days"));
          }}
        >
