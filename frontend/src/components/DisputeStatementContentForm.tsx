...
const DisputeStatementContentForm = (
  props: FormProps & {
    statementToDisputeContent?: StatementDB | StatementWithDetailsDB;
  },
) => {
  const [disputedStatementHash, setDisputedStatementHash] = React.useState(
    props.statementToDisputeContent?.hash_b64 || "",
  );
  ...
  const prepareStatement: prepareStatement = ({ method }) => {
    try {
      ...
      const content = buildDisputeContentContent({
