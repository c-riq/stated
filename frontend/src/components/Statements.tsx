...
const Statements = (props: props) => {
  ...
  return (
    <div
      style={
        lt850px ? { marginBottom: "10%" } : { margin: "2%", borderRadius: 8 }
      }
    >
      <div
        style={
          lt850px ? { width: "100vw" } : { width: "70vw", maxWidth: "900px" }
        }
      >
        <div
          style={{
        ...
        >
          <h3>Statements ({maxSkipId})</h3> {props.children}
        </div>
        <div style={lt850px ? {} : { minHeight: "50vh" }}>
          {statements && statements.length === 0 && (
            <div style={{ marginTop: "50px" }}>no statements found.</div>
          )}
          {statements &&
            statements.length > 0 &&
            statements.map((s, i) => {
              ...
              if (
                ...
                return (
                  <CompactStatement
                    key={i}
                    s={s}
                    setStatementToJoin={props.setStatementToJoin}
              ...
              if (s.type === statementTypes.poll) {
                ...
                const totalVotes = Object.values(votes || [0]).reduce(
                      ...
                      >
                        ...
                        {s.proclaimed_publication_time && (
                          <Tooltip title={s.proclaimed_publication_time}>
                            <span>
                              {timeSince(
                                new Date(s.proclaimed_publication_time),
                              )}
                            </span>
                          </Tooltip>
                        )}
                          ...
                          {Object.keys(votes).map((o) => (
                            ...
                            >
                              ...
                              >
                                <div
                                  style={{
                                    backgroundColor: "rgba(42, 74, 103, 0.5)",
                                    width:
                                      (totalVotes === 0
                                        ? 0
                                        : (200 * votes[o]) / totalVotes) + "px",
                                    height: "30px",
                                    borderRadius: "15px",
                                  }}
                                />
