  ...
  return (
    <React.Fragment>
      ...
      <Statements
        ...
        setStatementToJoin={joinStatement}
        ...
        {!lt850px && (
          <div>
            <FormControl sx={{ width: 300, height: "40px" }} size="small">
              <InputLabel id="filter-label" sx={{ margin: "0px 0px 0px 5px" }}>
      ...
      >
        ...
        >
          ...
          >
            <a
              href="https://github.com/c-riq/stated"
              style={{
                color: "rgba(255,255,255,1)",
                textDecoration: "none",
              }}
